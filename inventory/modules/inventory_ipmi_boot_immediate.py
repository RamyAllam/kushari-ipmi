...
from api.modules.ipmi_boot_immediate import start_ipmi_boot_immediate
from api.config.config_global import json_output_success_string, json_output_failed_string, json_output_error_string
import json
import ast


def start_inventory_ipmi_boot_immediate(server_name, boot_option='network'):
    ipmi_boot_immediate_data = dict()
    ipmi_boot_immediate_data['action'] = 'IPMI Inventory - Set boot option and reboot'
    ...
    try:
        ...
        if inventory_data['status'] == json_output_success_string:
            ...
            cmd_results = start_ipmi_boot_immediate(
            ...
            if cmd_results['status'] == json_output_success_string:
                ...
                ipmi_boot_immediate_data['data'] = cmd_results
            else:
        ...
        # If failed or no data in inventory
            ...
            ipmi_boot_immediate_data['status'] = json_output_failed_string
            ipmi_boot_immediate_data['data'] = inventory_data
        ...
        ipmi_boot_immediate_data['data'] = "{}".format(repr(e))
        return json.dumps(ipmi_boot_immediate_data)
