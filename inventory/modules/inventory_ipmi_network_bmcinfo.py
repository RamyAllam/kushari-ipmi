...
from api.modules.ipmi_network_bmcinfo import start_ipmi_network_bmcinfo
from api.config.config_global import json_output_success_string, json_output_failed_string, json_output_error_string
import json
import ast


def start_inventory_ipmi_network_bmcinfo(server_name):
    ipmi_network_bmcinfo_data = dict()
    ipmi_network_bmcinfo_data['action'] = 'IPMI Inventory - BMC Network info'
    ...
    try:
        ...
        if inventory_data['status'] == json_output_success_string:
            ...
            cmd_results = start_ipmi_network_bmcinfo(
        ...
        # If failed or no data in inventory
            ...
            ipmi_network_bmcinfo_data['status'] = json_output_failed_string
            ipmi_network_bmcinfo_data['data'] = inventory_data
        ...
        ipmi_network_bmcinfo_data['data'] = "{}".format(repr(e))
        return json.dumps(ipmi_network_bmcinfo_data)
