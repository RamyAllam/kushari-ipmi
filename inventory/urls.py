...
from .views import ipmi_chassis_power_status_view, ipmi_chassis_power_on_view, ipmi_chassis_power_off_view,\
    ipmi_chassis_power_reset_view, ipmi_chassis_power_osoff_view, ipmi_network_bmcinfo_view,\
    ipmi_network_bmcinfo_macaddress_view, ipmi_network_eth0info_macaddress_view, ipmi_boot_setnextboot_view,\
    ipmi_boot_immediate_view, ipmi_users_control_view, ipmi_chassis_power_cycle_view
...
urlpatterns = {
    ...
    url(r'^chassis/powercycle/$', ipmi_chassis_power_cycle_view, name="ipmi_chassis_power_cycle_view"),
